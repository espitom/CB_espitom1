...
//EXERCISE 1
//Step 1: Create a template or blueprint
function Saiyan (name, Saiyanlvl, hp){
    this.name = name;
    this.level = Saiyanlvl;
    this.health = hp * 2;
    this.attack = Saiyanlvl;
...
//Step 2: Initialize an Object with arguments
let goku = new Saiyan ("Goku", 5, 50);
let vegeta = new Saiyan ("Vegeta", 8, 40)
...
//Step 3: Execute the property
//For this example we execute the tackle property of Pikachu object
console.log(goku.tackle(vegeta));
console.log(goku.tackle(vegeta));
console.log(goku.tackle(vegeta));
...
//find() will return the "first" item that will
